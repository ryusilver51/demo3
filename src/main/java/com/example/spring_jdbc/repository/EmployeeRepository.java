...
public class EmployeeRepository {
  ...
  public List<Employee> findAll() {
    String sql = "SELECT id,name,age,gender,department_id FROM employees ORDER BY id ASC";
  ...
  public Employee save(Employee employee) {
    ...
    if (employee.getId() == null) {
      ...
      String updateSql = "UPDATE employees SET name=:name, age=:age," + "gender=:gender,department_id=:departmentId"
      + "WHERE id=:id";
